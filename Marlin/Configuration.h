...
//#define MACHINE_UUID "2615d5d5-5738-411a-86ca-bb8eadc05b5e"
...
// Originally set to 150C. Once flexable bed is changed to different material make change.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ender 3 Pro, non all metal hotend
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Taken from BIQU source for SKR mini e3 V2. Run auto tune to find values
